...
node "$ROOT/scripts/test-artifact-review-state.mjs"
...
node "$ROOT/scripts/render-excalidraw-diagram.mjs" --check \
  ...
  "$ROOT/skills/system-diagram/resources/excalidraw-slice-example.svg"
node "$ROOT/scripts/render-excalidraw-diagram.mjs" --check \
  "$ROOT/skills/system-diagram/resources/excalidraw-domain-interaction-example.json" \
  "$ROOT/skills/system-diagram/resources/excalidraw-domain-interaction-example.svg"
