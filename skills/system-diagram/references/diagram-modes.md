...
| Understand communication | Component Communication | modules/services, protocols, boundaries, ownership |
...
Lead with the user/system trigger and observable result. Components earn a node only when responsibility, boundary, state ownership, or failure changes.
