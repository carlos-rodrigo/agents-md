...
For v1 graphs, author and inspect the routes below. For v2 sequences, inspect the same legibility properties but repair semantic input or the renderer rather than authoring coordinates; `sequence-v1` owns layout.
...
- Embedded renderer-owned CSS, `data-diagram-style="infrastructure-v1"`, and version-matching provenance for `system-diagram-v1` graphs or `system-diagram-v2` sequences.
