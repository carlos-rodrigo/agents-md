...
- **Typography**: Choose fonts that are beautiful, unique, and interesting. Avoid defaulting to generic fonts like Arial and Inter unless the existing product/brand system already uses them. Pair a distinctive display font with a refined body font.
...
Before calling the UI done, run available project checks and do a quick manual smoke:
...
- core interaction path works without console errors.
